...
const projects = [
  {
    title: "Recipe Nuts (IN DEVELOPMENT)",
    type: "Mobile App",
    description: "Recipe Nuts is a mobile app that lets you easily save and store recipes from the web onto your device.",
    feature1Heading:"Streamline your Recipes",
    feature1Description:"Recipe sites often make it cumbersome to save and re-use recipes. This product extracts the recipe without the lengthy blog post or personal backstory. Store your recipes the easy way - just the essential recipe details, neatly organized in one place.",
    feature2Heading: "Technology Used",
    feature2Description: "Built with React Native and TypeScript for cross-platform support on Android and iOS. It leverages my custom REST Recipe Extractor API to parse recipe websites and return normalised, structured JSON recipe data.",
    feature3Heading:"Release Schedule",
    feature3Description:"Currently in the testing phase. I am aiming towards a public release in August 2025",
    summary:"Using an incremental release stradegy, The following features will appear post launch: meal planner, shopping list, dark mode toggle, cook mode toggle, scale ingredients and imperial/metric converter. Stay tuned!",
    getImage1Src: () => require("../images/recipenuts-1.png"),
    //getImage2Src: () => require("../images/project1.2.png"),
    //getImage3Src: () => require("../images/project1.3.png"),
    stack: ['React Native', 'TypeScript', 'Expo'],
    repo: "https://github.com/julian-jenkinson/Recipe-Nuts",
    //url: "https://Julian-Jenkinson.github.io/Straight-UI/",
    //urlLabel: "Play Store Listing",
  },
  {
  ...
  },
  {
    ...
    //getImage2Src: () => require("../images/project1.2.png"),
    //getImage3Src: () => require("../images/project1.3.png"),
    stack: ['React JS', 'TypeScript', 'Storybook', 'NPM', "Rollup", "Vite"],
