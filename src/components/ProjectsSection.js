...
const projects = [
  {
    ...
    summary:"Using an incremental release stradegy, The following features appear post launch: meal planner, shopping list, dark mode toggle, cook mode toggle, scale ingredients and imperial/metric converter. Stay tuned!",
